...
Plain `python -m http.server` does NOT match production, which matters here:
  ...
  * Pages serves /newsletter from newsletter.html. A plain server 404s it, so every
    internal link looks broken locally even though it works live.
  * Pages 308-redirects /newsletter.html to /newsletter. Links must use the
...
class PagesHandler(SimpleHTTPRequestHandler):
    def send_head(self):
        ...
        # /newsletter.html -> 308 /newsletter   ·   /index.html -> 308 /
